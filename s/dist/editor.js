/* f3171acb8647ec63cdce19425ba0bb7a147cfc0dfc6b249262b7c76563e800e5 */
var _0x0 = {
    user: null,
    settings: {
...
var _0x4e = new BroadcastChannel("editor"),
  _0x4f = JSON.parse(document.getElementById("editor-data").textContent),
  _0x50 = _0x4f.site,
  _0x51 = _0x4f.path;
_0x51.startsWith("/") || (_0x51 = "/" + _0x51);
var _0x52 = _0x4f.content,
  _0x53,
  _0x54 = null;
_0x51.endsWith(".html") && localStorage.setItem("lastHtmlFile", _0x51);
(_0x51.endsWith(".html") ||
  ((_0x51.endsWith(".css") || _0x51.endsWith(".js")) &&
    localStorage.getItem("lastHtmlFile"))) &&
  document.getElementById("preview-container").removeAttribute("hidden");
function _0x55() {
  let _0x2 = document.getElementById("preview-tile");
  if (!_0x2) return;
  (_0x54 && _0x54.unrender(), (_0x2.innerHTML = ""));
  let _0x5 = _0x51;
  ((_0x51.endsWith(".css") || _0x51.endsWith(".js")) &&
    localStorage.getItem("lastHtmlFile") &&
    (_0x5 = localStorage.getItem("lastHtmlFile")),
    (_0x51.endsWith(".html") ||
      ((_0x51.endsWith(".css") || _0x51.endsWith(".js")) &&
        localStorage.getItem("lastHtmlFile"))) &&
      (_0x54 = new _0x4d({
...
_0x55();
var _0x56;
function _0x57(_0x2, _0x5 = "success") {
  clearTimeout(_0x56);
  let _0x6 = document.getElementById("toast");
  ((_0x6.textContent = _0x2),
    (_0x6.className = `toast ${_0x5}`),
    _0x6.classList.add("show"),
    (_0x56 = setTimeout(
      () => {
        _0x6.classList.remove("show");
      },
      _0x5 === "saving" ? 1000 : 3000,
    )));
}
var _0x58 = "es5WarningDismissed",
  _0x59 = "apiInfoDismissed",
  _0x5a = "htmlWarningDismissed";
function _0x5b() {
  let _0x2 = document.getElementById("modal-overlay");
  return (
    _0x2 ||
      ((_0x2 = document.createElement("div")),
      (_0x2.id = "modal-overlay"),
      (_0x2.className = "modal-overlay"),
...
function _0x5c(_0x2) {
  ...
  ((_0x5.innerHTML = `
        <div class="modal-content">
            <h3 class="modal-title">Sandboxed Environment</h3>
            <div class="modal-body">
                <p>Your JavaScript runs in a <strong>sandboxed interpreter</strong> with limited APIs.</p>
                
                <p><strong>Available APIs:</strong></p>
                <ul>
                    <li><strong>DOM</strong> \u2014 no <code>innerHTML</code> setter, element count limits, sandboxed to your tile</li>
                    <li><strong>Canvas 2D</strong> \u2014 full drawing support with size limits</li>
                    <li><strong>XMLHttpRequest</strong> \u2014 external URLs only (no same-origin or relative requests)</li>
                    <li><strong>Events</strong> \u2014 <code>addEventListener</code>, click, keyboard, mouse, touch and other events.</li>
                    <li><strong>Timers</strong> \u2014 <code>setTimeout</code>, <code>setInterval</code></li>
                    <li><strong>localStorage</strong> \u2014 limited storage size</li>
                    <li>location, DOMParser, atob/btoa, console, alert/prompt/confirm</li>
                </ul>
            </div>
            <div class="modal-actions">
                <button class="btn btn-primary" id="modal-api-ok-btn">Got it!!!</button>
            </div>
        </div>
    `),
    _0x5.classList.add("active"),
    document
      .getElementById("modal-api-ok-btn")
      .addEventListener("click", () => {
        (localStorage.setItem(_0x59, "true"),
          _0x5.classList.remove("active"),
          _0x2 && _0x2());
      }));
}
function _0x5d(_0x2) {
  ...
  ((_0x5.innerHTML = `
        <div class="modal-content">
            <h3 class="modal-title">HTML Sanitization Notice</h3>
            <div class="modal-body">
                <p>Your HTML is <strong>sanitized</strong> for security. Some elements may be removed or modified.</p>
                
                <p><strong>Forbidden tags</strong> (will be removed):</p>
                <ul>
                    <li><code>&lt;iframe&gt;</code>, <code>&lt;object&gt;</code>, <code>&lt;embed&gt;</code>, <code>&lt;frame&gt;</code>, <code>&lt;frameset&gt;</code>, <code>&lt;svg&gt;</code>, <code>&lt;meta&gt;</code>, <code>&lt;title&gt;</code>, <code>&lt;base&gt;</code>, <code>&lt;applet&gt;</code>, <code>&lt;source&gt;</code></li>
                </ul>
                
                <p><strong>Limits:</strong></p>
                <ul>
                    <li>Max <strong>500 elements</strong> per page</li>
                    <li>Max <strong>3 stylesheets</strong> (<code>&lt;link rel="stylesheet"&gt;</code>)</li>
                    <li>Max <strong>3 relative scripts</strong> (<code>&lt;script src="/..."&gt;</code>)</li>
                </ul>
                
                <p><strong>Other restrictions:</strong></p>
                <ul>
                    <li>No external content. Everything must be uploaded to your files.</li>
                    <li>No inline event handlers (<code>onclick</code>, <code>onload</code>, etc.)</li>
                    <li>No <code>autoplay</code> on video/audio</li>
                    <li>CSS <code>@import</code> is removed. <code>var(--...)</code> is not supported.</li>
                    <li>Form actions can't target this domain</li>
                </ul>
            </div>
            <div class="modal-actions">
                <button class="btn btn-primary" id="modal-html-ok-btn">Understood</button>
            </div>
        </div>
    `),
    _0x5.classList.add("active"),
    document
      .getElementById("modal-html-ok-btn")
      .addEventListener("click", () => {
        (localStorage.setItem(_0x5a, "true"),
          _0x5.classList.remove("active"),
          _0x2 && _0x2());
      }));
}
function _0x5e(_0x2) {
  ...
  ((_0x5.innerHTML = `
        <div class="modal-content">
            <h3 class="modal-title">JavaScript Compatibility Notice</h3>
            <div class="modal-body">
                <p>Please note that only <strong>ES5 JavaScript</strong> is supported.</p>
                <p>The following features are <strong>not supported</strong>:</p>
                <ul>
                    <li><code>let</code> / <code>const</code> (use <code>var</code>)</li>
                    <li>Arrow functions <code>=&gt;</code></li>
                    <li>Template literals <code>\`...\`</code></li>
                    <li>Classes, destructuring, spread operator</li>
                    <li><code>async</code> / <code>await</code>, Promises</li>
                    <li>Modules (<code>import</code> / <code>export</code>)</li>
                </ul>
            </div>
            <div class="modal-actions">
                <button class="btn btn-primary" id="modal-ok-btn">Aight</button>
            </div>
        </div>
    `),
    _0x5.classList.add("active"),
    document.getElementById("modal-ok-btn").addEventListener("click", () => {
      (localStorage.setItem(_0x58, "true"),
        _0x5.classList.remove("active"),
        localStorage.getItem(_0x59) ? _0x2 && _0x2() : _0x5c(_0x2));
    }));
}
function _0x5f(_0x2) {
  return /<script[\s>]/i.test(_0x2) || _0x51.endsWith(".js");
}
function _0x60(_0x2) {
  return _0x5f(_0x2) && !localStorage.getItem(_0x58);
}
function _0x61(_0x2) {
  return (
    _0x5f(_0x2) && localStorage.getItem(_0x58) && !localStorage.getItem(_0x59)
  );
}
function _0x62() {
  return _0x51.endsWith(".html") && !localStorage.getItem(_0x5a);
}
function _0x63(_0x2) {
  (_0x57("Saving...", "saving"),
    fetch(`/api/files/write?domain=${_0x50}`, {
      method: "POST",
      ...
      .then(async (_0x5) => {
        if (_0x5.success) {
          if (
            ((_0x52 = _0x2),
            _0x57("File saved successfully", "success"),
            "serviceWorker" in navigator && navigator.serviceWorker.controller)
          ) {
            let _0x7 = Math.floor(Date.now() / 1000);
          ...
          let _0x6 = localStorage.getItem("lastHtmlFile");
          (_0x6 &&
            _0x6 !== _0x51 &&
            (await fetch(`/api/files/clear-cache?domain=${_0x50}`, {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({ path: _0x6 }),
            })),
            setTimeout(() => {
              (_0x55(),
                _0x4e.postMessage({
        ...
        } else _0x57("Error: " + _0x5.error, "error");
      })
      .catch((_0x5) => {
        _0x57("Error saving file: " + _0x5.message, "error");
      }));
}
function _0x64() {
  let _0x2 = _0x53.getValue();
  _0x62()
    ? _0x5d(() => {
        _0x60(_0x2)
          ? _0x5e(() => _0x63(_0x2))
...
document.getElementById("save-file-btn").addEventListener("click", _0x64);
document
  .getElementById("go-dashboard-btn")
  .addEventListener("click", function () {
    let _0x2 = _0x51.split("/");
    _0x2.pop();
    let _0x5 = _0x2.length >= 1 ? _0x2.join("/") : "/";
    window.location.href = `/dashboard?site=${encodeURIComponent(_0x50)}&path=${encodeURIComponent(_0x5)}`;
  });
function _0x65() {
  let _0x2 = _0x51.split(".").pop().toLowerCase(),
    _0x6 =
      {
        js: "javascript",
        html: "htmlmixed",
  ...
  _0x53 = CodeMirror(document.getElementById("editor-codemirror"), {
    value: _0x52 || "",
    mode: _0x6,
    theme: "monokai",
    lineNumbers: !0,
  ...
  let _0x7 = null;
  (_0x2 === "css"
    ? (_0x7 = CodeMirror.hint.css)
    : _0x2 === "js"
      ? (_0x7 = CodeMirror.hint.javascript)
      : _0x2 === "html"
        ? (_0x7 = CodeMirror.hint.html)
        : (_0x7 = CodeMirror.hint.anyword),
    _0x53.setOption("extraKeys", {
      "Ctrl-S": function (_0x9) {
        _0x64();
      },
      "Cmd-S": function (_0x9) {
        _0x64();
      },
      "Ctrl-Space": function (_0x9) {
        CodeMirror.commands.autocomplete(_0x9, _0x7);
      },
      "Ctrl-I": function (_0x9) {
        CodeMirror.commands.autocomplete(_0x9, _0x7);
      },
      "Ctrl-/": "toggleComment",
      "Cmd-/": "toggleComment",
  ...
  let _0x8;
  _0x53.on("inputRead", function (_0x9, _0xa) {
    _0xa.text.length > 0 &&
      (clearTimeout(_0x8),
      (_0x8 = setTimeout(function () {
        let _0xb = _0x9.getCursor(),
          _0xd = _0x9.getTokenAt(_0xb);
        _0xd.string.endsWith(";") ||
          (_0xd.string.length > 0 &&
            CodeMirror.commands.autocomplete(_0x9, _0x7, {
              completeSingle: !1,
            }));
      }, 50)));
...
window.addEventListener("beforeunload", (_0x2) => {
  _0x53 &&
    _0x53.getValue() !== _0x52 &&
    (_0x2.preventDefault(), (_0x2.returnValue = ""));
});
