var G = { user: null, settings: { logCalls: localStorage.logCalls === "true" } },
...
function it(t, c, h, g) {
  ...
  t.setProperty(
    w,
    "addColorStop",
    t.createNativeFunction(function (n, i) {
  ...
  (t.setProperty(b, "width", Interpreter.VALUE_IN_DESCRIPTOR, {
    ...
    t.setProperty(b, "data", Interpreter.VALUE_IN_DESCRIPTOR, {
      get: t.createNativeFunction(function () {
        ...
        (t.setProperty(u, "length", n.length),
          t.setProperty(
            u,
            "get",
            t.createNativeFunction(function (v) {
              return n[v];
            }),
          ),
          t.setProperty(
            u,
            "set",
            t.createNativeFunction(function (v, p) {
              (f.settings.logCalls && console.log("setImageData", this, v, p), (n[v] = p));
            }),
          ));
        for (let v = 0; v < Math.min(n.length, 1e3); v++)
          ((p) => {
  ...
  for (let n of H)
    t.setProperty(X, n, Interpreter.VALUE_IN_DESCRIPTOR, {
      get: t.createNativeFunction(function () {
  ...
  let B = t.createNativeFunction(function (n) {
    n && n.native
      ? (this.native = new Path2D(n.native))
      : typeof n == "string"
        ? (this.native = new Path2D(n))
  ...
  for (let n of Q)
    t.setProperty(V, n, Interpreter.VALUE_IN_DESCRIPTOR, {
      get: t.createNativeFunction(function () {
        return this.native[n];
      }),
  ...
  for (let n of ["fillStyle", "strokeStyle"])
    t.setProperty(V, n, Interpreter.VALUE_IN_DESCRIPTOR, {
      get: t.createNativeFunction(function () {
        let i = this.native[n];
        return i;
  ...
  let tt = {
    ...
    fillText: function (n, i, u, v) {
      (this.native,
        v !== void 0
          ? this.native.fillText(String(n).slice(0, 1e3), i, u, v)
          : this.native.fillText(String(n).slice(0, 1e3), i, u));
    },
    strokeText: function (n, i, u, v) {
      (this.native,
        v !== void 0
          ? this.native.strokeText(String(n).slice(0, 1e3), i, u, v)
          : this.native.strokeText(String(n).slice(0, 1e3), i, u));
    },
    ...
    isPointInPath: function (n, i, u, v) {
      return n?.native
        ? this.native.isPointInPath(n.native, i, u, v)
        : this.native.isPointInPath(n, i, u);
    },
    isPointInStroke: function (n, i, u) {
      return n?.native
        ? this.native.isPointInStroke(n.native, i, u)
        : this.native.isPointInStroke(n, i);
    },
    getTransform: function () {
      let n = this.native.getTransform();
      return t.nativeToPseudo({ a: n.a, b: n.b, c: n.c, d: n.d, e: n.e, f: n.f });
    },
    rotate: function (n) {
    ...
    drawImage: function (n, i, u, v, p, R, x, F, e) {
      ...
      o &&
        (F !== void 0
          ? this.native.drawImage(o, i, u, v, p, R, x, F, e)
          : v !== void 0
            ? this.native.drawImage(o, i, u, v, p)
            : this.native.drawImage(o, i, u));
    },
    ...
    putImageData: function (n, i, u, v, p, R, x) {
      (this.native,
        n?.native &&
          (v !== void 0
            ? this.native.putImageData(n.native, i, u, v, p, R, x)
            : this.native.putImageData(n.native, i, u)));
    },
    save: function () {
      this.native.save();
    },
  ...
  return {
    extendElement: function (n, i) {
      (t.setProperty(
        n,
        "getContext",
        t.createNativeFunction(function (u, v) {
        ...
        t.setProperty(n, "width", Interpreter.VALUE_IN_DESCRIPTOR, {
          ...
          set: t.createNativeFunction(function (u) {
            (f.settings.logCalls && console.log("set width", this, u),
              this.native.tagName === "CANVAS" && (this.native.width = Math.min(u, l)));
          }),
        }),
        t.setProperty(n, "height", Interpreter.VALUE_IN_DESCRIPTOR, {
          ...
          set: t.createNativeFunction(function (u) {
            (f.settings.logCalls && console.log("set height", this, u),
              this.native.tagName === "CANVAS" && (this.native.height = Math.min(u, l)));
          }),
        }),
        t.setProperty(
          n,
          ...
          t.createNativeFunction(function (u, v) {
            ...
            return (
              f.settings.logCalls && console.log("toDataURL", this, u, v),
              this.native.toDataURL(u, v)
            );
          }),
        ));
    },
...
function at(t, c) {
  ...
  function S(s) {
    ...
    try {
      ...
      if (
        r.origin === P ||
        r.hostname === "kicya.net" ||
        r.hostname.endsWith(".kicya.net") ||
        r.hostname === "nekoweb.org"
      )
        return !1;
  ...
  function T(s, ...r) {
    ...
    t.appendCode(
      `__xhrCallbacks.fn${y}(${M}); delete __xhrCallbacks.fn${y}; ${b.map((L) => `delete __xhrCallbacks.${L}`).join("; ")};`,
    );
  }
  let N = t.createNativeFunction(function () {
    (f.settings.logCalls && console.log("XMLHttpRequest", this),
    ...
    ((this.native.onreadystatechange = function () {
      (t.setProperty(r, "readyState", r.native.readyState),
        r.native.readyState === 4 &&
          (t.setProperty(r, "status", r.native.status),
          t.setProperty(r, "statusText", r.native.statusText),
          t.setProperty(r, "responseText", r.native.responseText?.slice(0, 5242880) || ""),
          t.setProperty(r, "responseURL", r.native.responseURL),
          (l = Math.max(0, l - 1))),
        r._eventHandlers.onreadystatechange && T(r._eventHandlers.onreadystatechange));
    }),
      ...
      t.setProperty(this, "readyState", 0),
      t.setProperty(this, "status", 0),
      t.setProperty(this, "statusText", ""),
      t.setProperty(this, "responseText", ""),
      t.setProperty(this, "responseURL", ""));
  }, !0);
  t.setProperty(c, "XMLHttpRequest", N);
  let w = t.getProperty(N, "prototype");
  (t.setProperty(N, "UNSENT", 0),
    t.setProperty(N, "OPENED", 1),
    t.setProperty(N, "HEADERS_RECEIVED", 2),
    t.setProperty(N, "LOADING", 3),
    t.setProperty(N, "DONE", 4),
    t.setProperty(w, "UNSENT", 0),
    t.setProperty(w, "OPENED", 1),
    t.setProperty(w, "HEADERS_RECEIVED", 2),
    t.setProperty(w, "LOADING", 3),
    t.setProperty(w, "DONE", 4));
  let E = [
    "onreadystatechange",
    "onload",
    "onerror",
  ...
  for (let s of E)
    t.setProperty(w, s, Interpreter.VALUE_IN_DESCRIPTOR, {
      get: t.createNativeFunction(function () {
        return this._eventHandlers[s] || null;
      }),
      set: t.createNativeFunction(function (r) {
        (f.settings.logCalls && console.log("XMLHttpRequest set " + s, this, r),
          (this._eventHandlers[s] = r));
      }),
    });
  (t.setProperty(w, "timeout", Interpreter.VALUE_IN_DESCRIPTOR, {
    ...
    t.setProperty(
      w,
      "open",
      t.createNativeFunction(function (s, r, y, b, M) {
        if (!S(r))
          throw new Error(
            `XHR request blocked: URL "${r}" is not allowed. Only absolute URLs to external origins are permitted.`,
          );
        let L = ["GET", "POST", "PUT", "DELETE", "PATCH", "HEAD", "OPTIONS"];
        if (((s = String(s).toUpperCase()), !L.includes(s)))
          throw new Error(`HTTP method "${s}" is not allowed`);
        (f.settings.logCalls && console.log("XMLHttpRequest open", this, s, r, y, b, M),
          (this._method = s),
          (this._url = r),
          (this._async = y !== !1),
          this.native.open(s, r, this._async),
          (this.native.timeout = 3e4),
          t.setProperty(this, "readyState", this.native.readyState));
      }),
    ),
    t.setProperty(
      w,
      "setRequestHeader",
      t.createNativeFunction(function (s, r) {
        if (
          ["cookie", "cookie2", "set-cookie", "set-cookie2", "host", "origin", "referer"].includes(
            s.toLowerCase(),
          )
        )
          throw new Error(`Setting header "${s}" is not allowed`);
        (f.settings.logCalls && console.log("XMLHttpRequest setRequestHeader", this, s, r),
          (this._headers[s] = r),
          this.native.setRequestHeader(s, r));
      }),
    ),
    t.setProperty(
      w,
      "send",
      t.createNativeFunction(function (s) {
        ...
        (s != null &&
          (typeof s == "string"
            ? (r = s.slice(0, 5242880))
            : typeof s == "object" && (r = JSON.stringify(t.pseudoToNative(s)))),
          this.native.send(r));
      }),
    ),
    t.setProperty(
      w,
      "abort",
      t.createNativeFunction(function () {
        (f.settings.logCalls && console.log("XMLHttpRequest abort", this),
          this.native.abort(),
          (l = Math.max(0, l - 1)));
      }),
    ),
    ...
    ((K = new Promise((t, c) => {
      ...
      ((h.onerror = () => c(h.error)),
        ...
        (h.onupgradeneeded = (g) => {
          ...
          d.objectStoreNames.contains(D) ||
            d
              .createObjectStore(D, { keyPath: ["site", "key"] })
...
async function pt(t, c, h) {
  return (
    await $(),
    new Promise((g, d) => {
      let S = k.transaction(D, "readwrite").objectStore(D).put({ site: t, key: c, value: h });
  ...
  return (
    ...
    new Promise((c, h) => {
      ...
      ((P.onsuccess = () => {
        ...
        c({ size: S, count: P.result.length });
      }),
        (P.onerror = () => h(P.error)));
    })
  );
...
function ht(t, c, h) {
  ...
  (t.setProperty(
    g,
    "getItem",
    t.createAsyncFunction(function (d, l) {
    ...
    t.setProperty(
      g,
      "setItem",
      t.createAsyncFunction(function (d, l, P) {
          ...
          ut(h)
            .then(({ size: S, count: _ }) => {
              lt(h, d)
                .then((C) => {
                  if (C === null && _ >= ct)
                    throw new Error(`localStorage item limit exceeded (max ${ct} items)`);
                  let N = C ? (d.length + C.length) * 2 : 0,
                    w = (d.length + l.length) * 2;
                  if (S - N + w > rt)
                    throw new Error(`localStorage size limit exceeded (max ${rt / 1024}KB)`);
                  return pt(h, d, l);
                })
                .then(() => P())
                .catch((C) => {
    ...
    t.setProperty(
      g,
      "clear",
      t.createAsyncFunction(function (d) {
        (f.settings.logCalls && console.log("localStorage.clear", this),
          St(h)
            .then(() => d())
            .catch((l) => {
    ...
    t.setProperty(c, "localStorage", g),
    t.setProperty(c, "sessionStorage", g));
}
$().catch((t) => {
...
function ft(t, c, h) {
  ...
  t.setProperty(
    d,
    "parseFromString",
    t.createNativeFunction(function (l, P) {
      if (
        (f.settings.logCalls && console.log("DOMParser parseFromString", this, l, P),
        ![
          "text/html",
          "text/xml",
          "application/xml",
        ...
        throw new Error(`DOMParser: Unsupported MIME type "${P}"`);
      if ((typeof l != "string" && (l = String(l)), l.length > 1e5))
      ...
      function N(w) {
        ...
        return (
          (E.native = w),
          (E.fromDOMParser = !0),
          t.setProperty(E, "nodeName", Interpreter.VALUE_IN_DESCRIPTOR, {
            get: t.createNativeFunction(function () {
          ...
          t.setProperty(E, "nodeValue", Interpreter.VALUE_IN_DESCRIPTOR, {
            ...
            set: t.createNativeFunction(function (s) {
              (f.settings.logCalls && console.log("DOMParser set nodeValue", this, s),
                (this.native.nodeValue = s));
            }),
          }),
          t.setProperty(E, "textContent", Interpreter.VALUE_IN_DESCRIPTOR, {
            ...
            set: t.createNativeFunction(function (s) {
              (f.settings.logCalls && console.log("DOMParser set textContent", this, s),
                (this.native.textContent = String(s).slice(0, 5e4)));
            }),
          }),
          ...
          t.setProperty(E, "id", Interpreter.VALUE_IN_DESCRIPTOR, {
            ...
            set: t.createNativeFunction(function (s) {
              (f.settings.logCalls && console.log("DOMParser set id", this, s),
                (this.native.id = String(s).slice(0, 100)));
            }),
          }),
          t.setProperty(E, "className", Interpreter.VALUE_IN_DESCRIPTOR, {
            ...
            set: t.createNativeFunction(function (s) {
              (f.settings.logCalls && console.log("DOMParser set className", this, s),
                (this.native.className = String(s).slice(0, 1e3)));
            }),
          }),
          ...
          t.setProperty(E, "parentNode", Interpreter.VALUE_IN_DESCRIPTOR, {
            get: t.createNativeFunction(function () {
              ...
              return this.native.isSameNode(h)
                ? null
                : (f.settings.logCalls && console.log("DOMParser get parentNode", this),
                  N(this.native.parentNode));
            }),
          }),
          t.setProperty(E, "parentElement", Interpreter.VALUE_IN_DESCRIPTOR, {
            get: t.createNativeFunction(function () {
              ...
              return this.native.isSameNode(h)
                ? null
                : (f.settings.logCalls && console.log("DOMParser get parentElement", this),
                  N(this.native.parentElement));
            }),
          }),
          t.setProperty(E, "nextSibling", Interpreter.VALUE_IN_DESCRIPTOR, {
            get: t.createNativeFunction(function () {
              ...
              return this.native.isSameNode(h)
                ? null
                : (f.settings.logCalls && console.log("DOMParser get nextSibling", this),
                  N(this.native.nextSibling));
            }),
          }),
          t.setProperty(E, "previousSibling", Interpreter.VALUE_IN_DESCRIPTOR, {
            get: t.createNativeFunction(function () {
              ...
              return this.native.isSameNode(h)
                ? null
                : (f.settings.logCalls && console.log("DOMParser get previousSibling", this),
                  N(this.native.previousSibling));
            }),
          }),
          t.setProperty(
            E,
          ...
          t.setProperty(
            ...
            t.createNativeFunction(function (s, r) {
              if (!this.fromDOMParser) throw new Error("No access.");
              if (((s = String(s).toLowerCase()), s.startsWith("on")))
                throw new Error("Event handlers are not allowed");
              (this.native.setAttribute(s, String(r)),
                f.settings.logCalls && console.log("DOMParser set attribute", this, s, r));
            }),
          ),
          t.setProperty(
            E,
          ...
          t.setProperty(
            ...
            t.createNativeFunction(function (s) {
              ...
              (this.native.removeAttribute(s),
                f.settings.logCalls && console.log("DOMParser remove attribute", this, s));
            }),
          ),
          t.setProperty(
            E,
      ...
      return (
        t.setProperty(T, "documentElement", Interpreter.VALUE_IN_DESCRIPTOR, {
          get: t.createNativeFunction(function () {
        ...
        t.setProperty(
          T,
          "querySelector",
          t.createNativeFunction(function (w) {
...
function dt(t, c, h, g) {
  ...
  function T(e, o) {
    let a = _++;
    (t.setProperty(C, "fn" + a, e),
      t.setProperty(C, "ev" + a, o),
      t.appendCode(
        `__eventCallbacks.fn${a}(__eventCallbacks.ev${a}); delete __eventCallbacks.fn${a}; delete __eventCallbacks.ev${a};`,
      ));
  }
  function N() {
  ...
  let L = t.getProperty(M, "prototype"),
    ...
    H = {
      textContent: function (e) {
        (f.settings.logCalls && console.log("set textContent", this, e),
          (this.native.textContent = e));
      },
  ...
  for (let [e, o] of Object.entries(X)) {
    let a = { get: t.createNativeFunction(o) };
    (H[e] && (a.set = t.createNativeFunction(H[e])),
      t.setProperty(L, e, Interpreter.VALUE_IN_DESCRIPTOR, a));
  }
  let J = {
    ...
    appendChild: function (e) {
      ...
      return (
        w(E(e.native)),
        this.native.appendChild(e.native),
        f.settings.logCalls && console.log("appendChild", this, e),
        e
      );
    },
    append: function (e) {
    ...
    removeChild: function (e) {
      return !e?.native || !r(e.native)
        ? null
        : (f.settings.logCalls && console.log("removeChild", this, e),
          s(this.native.removeChild(e.native)));
    },
    insertBefore: function (e, o) {
      ...
      let a = o?.native || null;
      return (
        this.native.insertBefore(e.native, a),
        f.settings.logCalls && console.log("insertBefore", this, e, a),
        e
      );
    },
    cloneNode: function (e) {
      return (
        f.settings.logCalls && console.log("cloneNode", this, e),
        s(this.native.cloneNode(e), this.fromDOMParser)
      );
    },
    contains: function (e) {
    ...
    after: function (e) {
      ...
      return (
        w(E(e.native)),
        this.native.after(e.native),
        f.settings.logCalls && console.log("after", this, e),
        e
      );
    },
    before: function (e) {
      ...
      return (
        w(E(e.native)),
        this.native.before(e.native),
        f.settings.logCalls && console.log("before", this, e),
        e
      );
    },
  };
  ...
  function j(e) {
    ...
    if (o.startsWith("javascript:") || o.startsWith("vbscript:"))
    ...
    try {
      ...
      return (
        m.startsWith(`/t/${g.domain}/`) || (m = `/t/${g.domain}/${m}`.replaceAll("//", "/")),
        m
      );
    } catch (a) {
      ...
      let m = e;
      return (
        !m.startsWith(`/t/${g.domain}/`) &&
          !m.startsWith("#") &&
          (m = `/t/${g.domain}/${m}`.replaceAll("//", "/")),
        m
      );
    }
  }
  let z = {
    ...
    V = {
      ...
      href: function (e) {
        ((this.native.href = this.native.tagName === "A" ? e : j(e)),
      ...
      currentTime: function (e) {
        this.native instanceof HTMLMediaElement &&
          (this.native.currentTime = Math.max(0, Number(e) || 0));
      },
      muted: function (e) {
      ...
      volume: function (e) {
        this.native instanceof HTMLMediaElement &&
          (this.native.volume = Math.max(0, Math.min(1, Number(e) || 0)));
      },
      loop: function (e) {
      ...
      playbackRate: function (e) {
        this.native instanceof HTMLMediaElement &&
          (this.native.playbackRate = Math.max(0.25, Math.min(4, Number(e) || 1)));
      },
      defaultPlaybackRate: function (e) {
        this.native instanceof HTMLMediaElement &&
          (this.native.defaultPlaybackRate = Math.max(0.25, Math.min(4, Number(e) || 1)));
      },
      preload: function (e) {
  ...
  for (let [e, o] of Object.entries(z)) {
    let a = { get: t.createNativeFunction(o) };
    (V[e] && (a.set = t.createNativeFunction(V[e])),
      t.setProperty(A, e, Interpreter.VALUE_IN_DESCRIPTOR, a));
  }
  let Q = {
    ...
    setAttribute: function (e, o) {
      ...
      if (
        ...
        (o = String(o)),
        f.settings.logCalls && console.log("setAttribute", this, e, o),
        e === "style" && o.includes("animation-play-state") && o.includes("!important"))
      )
    ...
    scrollIntoView: function (e) {
      e && typeof e == "object"
        ? this.native.scrollIntoView(t.pseudoToNative(e))
        : this.native.scrollIntoView(e);
    },
    ...
    removeAttribute: function (e) {
      if (this.native.className === "tile-body") throw new Error("No access.");
      if (((e = String(e).toLowerCase()), e === "target"))
        throw new Error("removing target is not allowed");
      (f.settings.logCalls && console.log("removeAttribute", this, e),
        this.native.removeAttribute(e));
    },
    ...
    play: function () {
      ...
      let e = t.createObjectProto(t.OBJECT_PROTO),
        ...
        m = null;
      return (
        f.settings.logCalls && console.log("play", this),
        t.setProperty(
          e,
          "then",
          t.createNativeFunction(function (I) {
            return ((a = I), e);
          }),
        ),
        t.setProperty(
        ...
        o.native
          ...
          .catch((I) => {
            m && T(m, t.nativeToPseudo({ message: I.message, name: I.name }));
          }),
        e
      );
    },
    ...
    canPlayType: function (e) {
      return this.native instanceof HTMLMediaElement
        ? this.native.canPlayType(String(e || ""))
        : "";
    },
    fastSeek: function (e) {
      this.native instanceof HTMLMediaElement &&
        typeof this.native.fastSeek == "function" &&
        this.native.fastSeek(Math.max(0, Number(e) || 0));
    },
    getAnimations: function (e) {
      if (!this.native.getAnimations) return b([]);
      let o = e ? { subtree: !!t.pseudoToNative(e)?.subtree } : {},
  ...
  function tt(e) {
    ...
    return (
      t.setProperty(o, "id", Interpreter.VALUE_IN_DESCRIPTOR, {
        get: t.createNativeFunction(function () {
          return e.id;
        }),
      }),
      ...
      t.setProperty(
        o,
        "updatePlaybackRate",
        t.createNativeFunction(function (a) {
  ...
  function n(e) {
    let o = t.createObjectProto(t.OBJECT_PROTO),
      a = e ? e.length : 0;
    return (
      t.setProperty(o, "length", a),
      t.setProperty(
        o,
        "start",
        t.createNativeFunction(function (m) {
  ...
  (t.setProperty(A, "buffered", Interpreter.VALUE_IN_DESCRIPTOR, {
      ...
      get: t.createNativeFunction(function () {
        ...
        return (
          ...
          t.setProperty(
            o,
            "toggle",
            t.createNativeFunction(function (a, m) {
              if (this.native.className === "tile-body") throw new Error("No access.");
              return e.toggle(a, m);
            }),
          ),
    ...
    t.setProperty(A, "style", Interpreter.VALUE_IN_DESCRIPTOR, {
      get: t.createNativeFunction(function () {
        ...
        for (let m of a)
          t.setProperty(o, m, Interpreter.VALUE_IN_DESCRIPTOR, {
            get: t.createNativeFunction(function () {
              return e[m];
            }),
            set: t.createNativeFunction(function (I) {
        ...
        return (
          t.setProperty(o, "cssText", Interpreter.VALUE_IN_DESCRIPTOR, {
            get: t.createNativeFunction(function () {
              return e.cssText;
            }),
          ...
          t.setProperty(
            o,
            "setProperty",
            t.createNativeFunction(function (m, I, O) {
              if (this.native?.className === "tile-body") throw new Error("No access.");
              (e.setProperty(m, I, O),
                f.settings.logCalls && console.log("setProperty", this, m, I, O));
            }),
          ),
          t.setProperty(
            o,
          ...
          t.setProperty(
            ...
            t.createNativeFunction(function (m) {
              if (this.native?.className === "tile-body") throw new Error("No access.");
              return (
                f.settings.logCalls && console.log("removeProperty", this, m),
                e.removeProperty(m)
              );
            }),
          ),
      ...
      get: t.createNativeFunction(function () {
        ...
        return (
          ...
          t.setProperty(
            ...
            "set",
            t.createNativeFunction(function (a, m) {
              ((e[a] = String(m).slice(0, 1e3)),
                f.settings.logCalls && console.log("set dataset", this, a, m));
            }),
          ),
          t.setProperty(
            o,
  ...
  function u(e) {
    ...
    return (
      typeof TouchEvent == "function" &&
        ...
        (t.setProperty(o, "touches", t.nativeToPseudo({ length: e.touches.length })),
        t.setProperty(o, "changedTouches", t.nativeToPseudo({ length: e.changedTouches.length }))),
      typeof WheelEvent == "function" &&
        e instanceof WheelEvent &&
        (t.setProperty(o, "deltaX", e.deltaX),
        t.setProperty(o, "deltaY", e.deltaY),
        t.setProperty(o, "deltaZ", e.deltaZ),
        t.setProperty(o, "deltaMode", e.deltaMode)),
      e.target && r(e.target) && t.setProperty(o, "target", s(e.target)),
      e.currentTarget &&
        r(e.currentTarget) &&
        t.setProperty(o, "currentTarget", s(e.currentTarget)),
      t.setProperty(
        o,
        "preventDefault",
        t.createNativeFunction(function () {
  ...
  (t.setProperty(
    A,
    "addEventListener",
    t.createNativeFunction(function (e, o) {
      if (!e || typeof e != "string" || !o || typeof o != "object") return;
      if (((e = e.toLowerCase()), !i.includes(e)))
        throw new Error(`Event type "${e}" is not allowed`);
      ...
      (I.push({ pseudo: o, native: O }), a.addEventListener(e, O));
    }),
  ),
    t.setProperty(
      A,
      ...
      t.createNativeFunction(function (e, o) {
        if (!e || typeof e != "string" || !o || typeof o != "object") return;
        (f.settings.logCalls && console.log("removeEventListener", this, e, o),
          (e = e.toLowerCase()));
        let a = this.native;
        if (!S.has(a)) return;
        let m = S.get(a);
  ...
  for (let e of v) {
    ...
    t.setProperty(A, o, Interpreter.VALUE_IN_DESCRIPTOR, {
      ...
      set: t.createNativeFunction(function (a) {
        ...
        if (
          (U && (m.removeEventListener(e, U), I.delete(O), I.delete(O + "_native")),
          a && typeof a == "object")
        ) {
          let Y = function (yt) {
            let Pt = u(yt);
  ...
  let x = {
    ...
    createElement: function (e) {
      ...
      if (
        ...
        throw new Error("Creating " + e + " elements is not allowed");
      return (
        f.settings.logCalls && console.log("createElement", this, e),
        s(document.createElement(e))
      );
    },
    createTextNode: function (e) {
      return (
        f.settings.logCalls && console.log("createTextNode", this, e),
  ...
  (t.setProperty(c, "location", F),
    t.setProperty(F, "href", Interpreter.VALUE_IN_DESCRIPTOR, {
      get: t.createNativeFunction(function () {
      ...
      set: t.createNativeFunction(function (e) {
        if (typeof e == "string") {
          ...
          try {
            ...
            if (o.hostname && o.hostname !== location.hostname)
              throw new Error("External URLs are not allowed");
            let a = o.pathname + o.search + o.hash;
            if (
              (a.startsWith(`/t/${g.domain}/`)
                ? (a = a.substring(`/t/${g.domain}`.length))
                : a === `/t/${g.domain}` && (a = "/"),
              a.startsWith("/") || (a = "/" + a),
              a.endsWith(".html") || a === "/" || a === "")
            )
              (g.fetchContent(a || "/index.html"), g.setActive(!0));
            ...
            let a = e;
            if ((a.startsWith("/") || (a = "/" + a), a.endsWith(".html") || a === "/" || a === ""))
              g.fetchContent(a || "/index.html").then(() => g.setActive(!0));
            else throw new Error("Only HTML files can be navigated to");
          }
        }
      }),
  ...
  et = class {
    constructor(c) {
      ((this.running = !1),
        ...
        (this.interpreter = new Interpreter("", (h, g) => {
          let d = (l, P) => {
          ...
          (d(Tt, g),
            dt(h, g, this.tile.contentElement, this.tile),
            h.setProperty(g, "embedded", h.nativeToPseudo(!!this.tile.embed)));
        })),
                ...
                if (this.index++ % 500 === 0) {
                  ...
                  if (h > 3e6) {
                    ((this.sizeLimitReached = !0),
                      this.stop(),
                      console.log(`[${this.tile.domain}] Memory size limit reached: ${h} bytes`));
                    break;
                  }
                }
              } catch (h) {
...
var q = class t {
  constructor(c) {
    ((this.x = c.x ?? 0),
      ...
      (this.path = c.path || "/index.html"),
      (this.content = ""),
      (this.lastRender = 0),
      (this.preview = c.nocontrols || !1),
      (this.embed = c.embed || !1),
      (this.container = c.container || It),
      (this.interpreter = null),
      this.render());
  }
  static toTilePosition(c, h) {
    return { x: Math.floor(c / 250), y: Math.floor(h / 250) };
  }
  render() {
    ...
    (c.classList.add("tile"),
      this.free && c.classList.add("f"),
      this.preview
        ? (c.style.cssText = "width: 100%; height: 100%; position: relative;")
        : ((c.style.left = `${this.x * 250}px`),
          (c.style.top = `${this.y * 250}px`),
          this.x % 10 === 0 && c.classList.add("b-left"),
          this.y % 10 === 0 && c.classList.add("b-top")),
      (this.element = c));
    let h = document.createElement("div");
    (h.classList.add("tile-content"),
      this.preview && (h.style.cssText = "width: 100%; height: 100%;"),
      h.addEventListener("click", async (d) => {
        ...
        if (_) {
          ...
          try {
            ...
            let T = C.pathname;
            if (
              (T.startsWith(`/t/${this.domain}/`) ||
                (T = `/t/${this.domain}/${T}`.replaceAll("//", "/")),
              T.startsWith(`/t/${this.domain}`) &&
                (T.endsWith(".html") || T === `/t/${this.domain}/` || T === `/t/${this.domain}`))
            )
              (await this.fetchContent(T.replace(`/t/${this.domain}`, "")), this.setActive(!0));
            else {
              let N = document.createElement("a");
              ((N.href = _.href), (N.target = "_blank"), N.click());
            }
      ...
      (this.shadow = h.attachShadow({ mode: "open" })));
    let g = document.createElement("div");
    ((g.className = "tile-body"),
      this.embed && g.classList.add("embedded"),
      (g.style =
        "width: 100%!important; height: 100%!important;position:absolute!important;top:0!important;left:0!important;"),
      (this.contentElement = g),
      (this.contentElement.innerHTML = this.preview
        ? "Loading preview..."
        : `Loading ${this.x}, ${this.y}...`),
      this.shadow.appendChild(g),
      c.appendChild(h),
      (this.fonts = document.createElement("style")),
      c.appendChild(this.fonts),
      this.fetchContent(this.path),
      this.container && this.container.appendChild(c),
      f.plot?.lockCache[this.x + "," + this.y] && this.setLocked(!0));
  }
  unrender() {
    !this.rendered ||
      !this.element ||
  ...
  async fetchContent(c, h = !1) {
    ...
    let g = this.free
      ...
      : this.path === c && this.content && !h
        ? this.content
        : await fetch(`/t/${this.domain}${c}`)
            .then((P) => P.text())
            .catch((P) => "<p>Error loading tile</p>");
    (this.free ? (this.shadow.adoptedStyleSheets = [mt]) : (this.shadow.adoptedStyleSheets = [nt]),
      this.interpreter && (this.interpreter.stop(), (this.interpreter = null)),
      (this.path = c),
      (this.contentElement.innerHTML = g),
      (this.content = g));
  ...
  setActive(c) {
    if (
      this.element &&
      (c &&
        (this.interpreter || ((this.interpreter = new vt(this)), this.executeScripts()),
      ...
      if (((this.active = c), c)) {
        if (
          ...
          (f.plot?.activeTile && f.plot.activeTile.setActive(!1),
            f.plot && (f.plot.activeTile = this),
            this.fetchAndShowClanBorders());
        }
        let h = this.contentElement.querySelectorAll("audio, video");
        for (let g of h)
          g.dataset.webtilesPaused === "true" && ((g.dataset.webtilesPaused = !1), g.play());
      } else if (!this.preview) {
        (this.interpreter && this.interpreter.stop(),
          (f.plot.activeTile = null),
  ...
  async fetchAndShowClanBorders() {
    if (!(this.free || !this.domain))
      try {
        let h = await (
          await f.api.makeRequest(`/api/clans/tile-clan?domain=${encodeURIComponent(this.domain)}`)
        ).json();
  ...
  static clearClanBorders() {
    if (f.plot?.tiles)
      for (let c of Object.values(f.plot.tiles))
        c.element &&
          (c.element.classList.remove("clan-highlight"),
          c.element.querySelectorAll(".clan-border").forEach((g) => g.remove()));
  }
  setDomain(c) {
    ((this.domain = c),
      (this.free = !1),
  ...
  static updateLowendStyles() {
    if ((gt(), f.plot && f.plot.tiles))
      for (let c of Object.values(f.plot.tiles))
        c.shadow && !c.free && (c.shadow.adoptedStyleSheets = [nt]);
  }
  setLocked(c) {
    ((this.locked = c),
      this.element && this.element.classList.toggle("locked", c),
